...
#ifndef _THORLABSGIMBAL_H_
#define _THORLABSGIMBAL_H_
...
class ThorlabsGimbal : public CStageBase<ThorlabsGimbal>
{
public:
    ThorlabsGimbal();
    ThorlabsGimbal(int hwType, std::string deviceName, long chNumber);
    ~ThorlabsGimbal();
